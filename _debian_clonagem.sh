...
################################################################################
# Script Name:  debian_clonagem.sh
# Description:  Um script para clonar discos usando dd ou rsync e preparar 
#               novos discos com partições e sistemas de arquivos configurados.
#               Configurar máquinas rapidamente no laboratório.
