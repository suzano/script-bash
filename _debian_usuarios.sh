...
################################################################################
# Script Name:  debian_usuarios.sh
# Description:  Adiciona, remove ou ajusta permissões de usuários no sistema. 
#               Pode ser útil para gerenciar contas em laboratórios.
#               Facilita o gerenciamento de usuários em ambientes compartilhados.
