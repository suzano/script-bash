...
################################################################################
# Script Name:  debian_rede.sh
# Description:  Testa a velocidade de download/upload usando ferramentas como 
#               speedtest-cli e registra os resultados em um arquivo.
#               Monitorar a qualidade da rede e identificar problemas.
