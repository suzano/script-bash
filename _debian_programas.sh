...
################################################################################
# Script Name:  debian_programas.sh
# Description:  Automatiza a instalação de programas comuns usados no 
#               laboratório, como navegadores, IDEs, e ferramentas específicas
#               (Exemplo: sudo apt install -y vlc gimp git).
#               Economizar tempo ao configurar novos sistemas.
