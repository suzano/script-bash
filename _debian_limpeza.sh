...
################################################################################
# Script Name:  debian_limpeza.sh
# Description:  Remove arquivos temporários, cache e outros arquivos 
#               desnecessários que ocupam espaço no disco.
#               Mantém o sistema limpo e com melhor desempenho.
